...
public class Controller {
    ...
    /**
     * Starts a new sale. This method must be called before anything else during a sale.
     */
    public void newSale() {
        sale = new Sale();
    ...
    public void sendSaleInfo() {
        ...
        externalInventorySystem.saleInformation(soldItems);
        accountingSystem.processSaleInformation(soldItems);
    }
